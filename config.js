...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? 'Made By Miss Aliza' : process.env.ALL_CAPTION,
    ...
    PLK: process.env.OWNER_NAME === undefined ? 'WHITE SER' : process.env.OWNER_NAME,
    ...
    SAID: process.env.BGM_DURATION === undefined ? '100' : process.env.BGM_DURATION,
    FULLEVA: process.env.FULL_EVA === undefined ? 'false' : process.env.FULL_EVA,
    ...
    BOTSK: process.env.BOT_NAME === undefined ? 'MISS ALIZA' : process.env.BOT_NAME,
    ...
    SUDO: process.env.SUDO === undefined ? '17098008221,0' : process.env.SUDO,
    DEBUG: DEBUG,
